...
export class Matrix3x3{
    ...
    public static IDENTITY = Object.freeze(new Matrix3x3());
     ...
     * @zh 复制目标矩阵
     */
    public static copy (out: Matrix3x3, a: Matrix3x3) {
        out.m00 = a.m00;
        out.m01 = a.m01;
        out.m02 = a.m02;
        out.m03 = a.m03;
     ...
     * @zh 将目标赋值为单位矩阵
     */
    public static identity (out: Matrix3x3) {
        out.m00 = 1;
        out.m01 = 0;
        out.m02 = 0;
        out.m03 = 0;
     ...
     * @zh 转置矩阵
     */
    public static transpose(out: Matrix3x3, a: Matrix3x3) {
     ...
     * @zh 矩阵求逆
     */
    public static invert(out: Matrix3x3, a: Matrix3x3) {
     ...
     * @zh 矩阵行列式
     */
    public static determinant(a: Matrix3x3) {
        _a00 = a.m00; _a01 = a.m01; _a02 = a.m02;
        _a10 = a.m03; _a11 = a.m04; _a12 = a.m05;
        _a20 = a.m06; _a21 = a.m07; _a22 = a.m08;
     ...
     * 取四阶矩阵的前三阶，与三阶矩阵相乘
     */
    public static multiplyMat4(out: Matrix3x3, a: Matrix3x3, b: Matrix4x4) {
        _a00 = a.m00; _a01 = a.m01; _a02 = a.m02;
        _a10 = a.m03; _a11 = a.m04; _a12 = a.m05;
        _a20 = a.m06; _a21 = a.m07; _a22 = a.m08;

        let bData = b.data;
        const b00 = bData[0], b01 = bData[1], b02 = bData[2];
        const b10 = bData[4], b11 = bData[5], b12 = bData[6];
        const b20 = bData[8], b21 = bData[9], b22 = bData[10];
     ...
     * @zh 在给定矩阵变换基础上加入变换
     */
    public static transfrom(out: Matrix3x3, a: Matrix3x3, v: Vector3) {
        _a00 = a.m00; _a01 = a.m01; _a02 = a.m02;
        _a10 = a.m03; _a11 = a.m04; _a12 = a.m05;
        _a20 = a.m06; _a21 = a.m07; _a22 = a.m08;
        const x = v.x, y = v.y;
     ...
     */
    public static scale(out: Matrix3x3, a: Matrix3x3, v: Vector3) {
        const x = v.x, y = v.y;
     ...
     * @param rad 旋转弧度
     */
    public static rotate(out: Matrix3x3, a: Matrix3x3, rad: number) {
        _a00 = a.m00; _a01 = a.m01; _a02 = a.m02;
        _a10 = a.m03; _a11 = a.m04; _a12 = a.m05;
        _a20 = a.m06; _a21 = a.m07; _a22 = a.m08;
     ...
     * @zh 取四阶矩阵的前三阶
     */
    public static fromMat4 (out: Matrix3x3, a: Matrix4x4) {
        let aData = a.data;
        out.m00 = aData[0];
        out.m01 = aData[1];
        out.m02 = aData[2];
     ...
     */
    public static fromViewUp(out: Matrix3x3, view: Vector3, up?: Vector3) {
        if (view.lengthSqr() < EPSILON * EPSILON) {
            Matrix3x3.identity(out);
            return out;
        }

        up = up || Vector3.UNIT_Y;;
        v3_1 = up.cross(view).normalize();

        if (v3_1.lengthSqr() < EPSILON * EPSILON) {
            Matrix3x3.identity(out);
            return out;
        }

        let aView : Vector3 = new Vector3(view.x, view.y, view.z);
        v3_2 = aView.cross(v3_1);
        Matrix3x3.set(
            out,
     ...
     * @zh 计算位移矩阵
     */
    public static fromTranslation (out: Matrix3x3, v: Vector3) {
        out.m00 = 1;
        out.m01 = 0;
        out.m02 = 0;
        out.m03 = 0;
     ...
     * @zh 计算缩放矩阵
     */
    public static fromScaling(out: Matrix3x3, v: Vector3) {
        out.m00 = v.x;
        out.m01 = 0;
        out.m02 = 0;
     ...
     * @zh 计算旋转矩阵
     */
    public static fromRotation(out: Matrix3x3, rad: number) {
     ...
     * @zh 根据四元数旋转信息计算矩阵
     */
    public static fromQuat(out: Matrix3x3, q: Quaternion) {
     ...
     * @zh 计算指定四维矩阵的逆转置三维矩阵
     */
    public static inverseTransposeMat4(out: Matrix3x3, aM: Matrix4x4) {
        let a = aM.data;
     ...
     * @param ofs 数组内的起始偏移量
     */
    public static toArray(out: Matrix3x3, m: Matrix3x3, ofs = 0) {
        out[ofs + 0] = m.m00;
        out[ofs + 1] = m.m01;
        out[ofs + 2] = m.m02;
        out[ofs + 3] = m.m03;
     ...
     * @param ofs 数组起始偏移量
     */
    public static fromArray(out: Matrix3x3, arr: Array<number>, ofs = 0) {
        out.m00 = arr[ofs + 0];
        out.m01 = arr[ofs + 1];
        out.m02 = arr[ofs + 2];
        out.m03 = arr[ofs + 3];
     ...
     * @zh 逐元素矩阵加法
     */
    public static add(out: Matrix3x3, a: Matrix3x3, b: Matrix3x3) {
        out.m00 = a.m00 + b.m00;
        out.m01 = a.m01 + b.m01;
        out.m02 = a.m02 + b.m02;
        out.m03 = a.m03 + b.m03;
     ...
     * @zh 逐元素矩阵减法
     */
    public static subtract (out: Matrix3x3, a: Matrix3x3, b: Matrix3x3) {
        out.m00 = a.m00 - b.m00;
        out.m01 = a.m01 - b.m01;
        out.m02 = a.m02 - b.m02;
        out.m03 = a.m03 - b.m03;
     ...
     * @zh 矩阵标量乘法
     */
    public static multiplyScalar(out: Matrix3x3, a: Matrix3x3, b: number) {
        out.m00 = a.m00 * b;
        out.m01 = a.m01 * b;
        out.m02 = a.m02 * b;
        out.m03 = a.m03 * b;
     ...
     */
    public static multiplyScalarAndAdd(out: Matrix3x3, a: Matrix3x3, b: Matrix3x3, scale: number) {
     ...
     * @zh 矩阵等价判断
     */
    public static strictEquals(a: Matrix3x3, b: Matrix3x3) {
     ...
     * @zh 排除浮点数误差的矩阵近似等价判断
     */
    public static equals <Out extends Matrix3x3> (a: Out, b: Out, epsilon = EPSILON) {
        return (
    ...
    constructor (
        m00: number | Matrix3x3 = 1, m01: number = 0, m02: number = 0,
    ...
    public set (m00: number | Matrix3x3 = 1, m01: number = 0, m02: number = 0,
                m03: number = 0, m04: number = 1, m05: number = 0,
                m06: number = 0, m07: number = 0, m08: number = 1 ) {
        if (typeof m00 === 'object') {
            this.m00 = m00.m00; this.m01 = m00.m01; this.m02 = m00.m02;
     ...
     */
    public equals (other: Matrix3x3, epsilon = EPSILON): boolean {
        return (
     ...
     * @returns 两矩阵的各元素都分别相等时返回 `true`；否则返回 `false`。
     */
    public strictEquals (other: Matrix3x3): boolean {
...
let v3_1 = new Vector3();
let v3_2 = new Vector3();