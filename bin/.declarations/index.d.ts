...
declare module "event/EventObject" {
...
declare module "math/Vector3Notifier" {
...
declare module "math/Matrix4Notifier" {
...
declare module "math/EulerNotifier" {
...
declare module "constants/glConstants" {
    export let glConstants: {
...
declare module "renderer/RenderInfo" {
    /**
     * 渲染信息
     * @class
     */
...
declare module "renderer/RenderList" {
...
declare module "light/DirectionLight" {
    import { Vector3 } from "math/Vector3";
...
declare module "light/LightManager" {
    /**
     * 光管理类
     * @class
     */
...
declare module "renderer/extensions" {
    /**
     * WebGL 扩展
    ...
    const extensions: {
         ...
         */
        get(name: string, alias?: string): any;
        /**
         * 禁止扩展
         * @param  {String} name 扩展名称
         */
        ...
        _getExtension(name: any): any;
    };
    export default extensions;
}
declare module "renderer/GLBuffer" {
    ...
    class GLBuffer {
         ...
         * @return {GLBuffer}
         */
        static createVertexBuffer(gl: WebGLRenderingContext, geometryData: any, usage?: number): any;
        static createBuffer(gl: any, target: any, geometryData: any, usage: any): any;
        /**
         * 生成索引缓冲
         * @param  {WebGLRenderingContext} gl
         * @param  {GeometryData} geometryData
         ...
         * @return {GLBuffer}
         */
        static createIndexBuffer(gl: any, geometryData: any, usage?: number): any;
        /**
         * id
         * @type {String}
         */
        ...
        */
         ...
         * @param  {GLenum} [usage = STATIC_DRAW]
         */
        constructor(gl: any, target: number, data: any, usage?: number);
        getClassName(): string;
        /**
         * 绑定
         ...
         * @return {GLBuffer} this
         */
        bufferSubData(byteOffset: any, data: any, isBinding?: boolean): this;
        /**
         * @param  {GeometryData} geometryData
         * @return {GLBuffer} this
         */
        uploadGeometryData(geometryData: any): this;
        /**
         * 没有被引用时销毁资源
         * @param  {WebGLRenderer} renderer
         * @return {GLBuffer} this
...
declare module "utils/bufferUtil" {
...
declare module "renderer/VertexArrayObject" {
    import { Pool } from "utils/Pool";
    /**
     * VAO
     * @class
...
declare module "renderer/WebGLResourceManager" {
    import { Mesh } from "core/Mesh";
    import VertexArrayObject from "renderer/VertexArrayObject";
    /**
...
declare module "renderer/WebGlState" {
    /**
...
declare module "renderer/capabilities" {
    /**
     * WebGL 能力
    ...
    const capabilities: {
         ...
         * @type {String}
         */
        MAX_VERTEX_PRECISION: any;
        /**
         * 最高片段着色器精度, 可以是以下值：highp, mediump, lowp
         * @type {String}
         */
        MAX_FRAGMENT_PRECISION: any;
        /**
         * 顶点浮点数纹理
         * @type {Boolean}
         */
        VERTEX_TEXTURE_FLOAT: any;
        /**
         * 片段浮点数纹理
         * @type {Boolean}
         */
        FRAGMENT_TEXTURE_FLOAT: any;
        /**
         ...
         */
        get(name: any): any;
        _getMaxSupportPrecision(shaderType: any): string;
        /**
         * 获取最大支持精度
         * @param  {String} a
         * @param  {String} b
         * @return {String}
         */
        getMaxPrecision(a: any, b: any): any;
    };
    export default capabilities;
}
declare module "renderer/glType" {
    /**
     * @namespace glType
     * @type {Object}
     */
...
declare module "texture/Texture" {
    import { Pool } from "utils/Pool";
...
declare module "renderer/RenderOptions" {
...
declare module "renderer/TextureOptions" {
...
declare module "renderer/Semantic" {
    import { WebGLState } from "renderer/WebGlState";
    import { Camera } from "camera/Camera";
...
declare module "renderer/Program" {
    ...
    export class Program {
         ...
         * @return {Program}
         */
        static getProgram(shader: Shader, state: WebGLState, ignoreError?: boolean): any;
        /**
         * 获取空白程序
         * @param  {WebGLState} state
         * @return {Program}
...
declare module "renderer/WebGLRenderer" {
    ...
    import { LightManager } from "light/LightManager";
    import WebGLResourceManager from "renderer/WebGLResourceManager";
    import { WebGLState } from "renderer/WebGlState";
...
declare module "camera/PerspectiveCamera" {
    import { Camera } from "camera/Camera";
...
declare module "camera/index" {
    export * from "camera/Camera";
    export * from "camera/PerspectiveCamera";
}
declare module "constants/glExtensionsConstants" {
...
declare module "constants/vertexType" {
    export let vertexType: {
        POSITION: string;
        NORMAL: string;
        DEPTH: string;
        DISTANCE: string;
...
declare module "constants/index" {
    export * from "constants/glConstants";
    export * from "constants/glExtensionsConstants";
    export * from "constants/vertexType";
}
declare module "core/HashObject" {
...
declare module "geometry/GeometryData" {
...
declare module "geometry/BoxGeometry" {
...
declare module "geometry/index" {
    ...
    export * from "geometry/GeometryData";
}
declare module "light/index" {
    export * from "light/AmbientLight";
    export * from "light/DirectionLight";
    export * from "light/Light";
    export * from "light/LightManager";
}
declare module "loader/LoadCache" {
    import { EventObject } from "event/EventObject";
    /**
     * 加载缓存类
     * @class
...
declare module "loader/BasicLoader" {
    import LoadCache from "loader/LoadCache";
    import { EventObject } from "event/EventObject";
    /**
     * 基础的资源加载类
     * @class
    ...
    class BasicLoader extends EventObject {
        static _cache: LoadCache;
        static enalbeCache(): void;
        static disableCache(): void;
        static deleteCache(key: any): void;
        static clearCache(): void;
        static get cache(): LoadCache;
        static set cache(vale: LoadCache);
        getClassName(): string;
        /**
         ...
         * @return {boolean} 是否跨域
         */
        isCrossOrigin(url: any): boolean;
        isBase64(url: any): boolean;
        Uint8ArrayFrom(source: any, mapFn: any): Uint8Array;
        /**
         * 加载图片
         ...
         */
        loadImg(url: any, crossOrigin: any): Promise<any>;
        /**
         * 使用XHR加载其他资源
         ...
         */
        loadRes(url: any, type: any): Promise<any>;
        /**
         * XHR资源请求
         ...
         * @return {Promise.<data, Error>} 返回加载完的内容对象(Object, ArrayBuffer, String)
         */
        request(opt: any): Promise<unknown>;
    }
...
declare module "loader/index" {
    export * from "loader/BasicLoader";
    export * from "loader/LoadCache";
    export * from "loader/Loader";
}
declare module "material/GeometryMaterial" {
...
declare module "material/index" {
    export * from "material/BasicMaterial";
    export * from "material/GeometryMaterial";
...
declare module "math/index" {
    ...
    export * from "math/EulerNotifier";
    export * from "math/Frustum";
    export * from "math/math";
    export * from "math/Matrix3";
    export * from "math/Matrix4";
    export * from "math/Matrix4Notifier";
    ...
    export * from "math/Vector3Notifier";
    export * from "math/Vector4";
}
declare module "renderer/index" {
    export * from "renderer/capabilities";
    export * from "renderer/extensions";
    export * from "renderer/GLBuffer";
    export * from "renderer/glType";
    export * from "renderer/Program";
    export * from "renderer/RenderInfo";
    export * from "renderer/RenderList";
    export * from "renderer/RenderOptions";
    export * from "renderer/Semantic";
    export * from "renderer/TextureOptions";
    export * from "renderer/VertexArrayObject";
    export * from "renderer/WebGLRenderer";
    export * from "renderer/WebGLResourceManager";
    export * from "renderer/WebGlState";
}
declare module "shader/index" {
    export * from "shader/shader";
}
declare module "texture/LazyTexture" {
    import Texture from "texture/Texture";
    /**
     * 懒加载纹理
     * @class
    ...
    class LazyTexture extends Texture {
         ...
         */
        load(throwError?: boolean): any;
        _releaseImage(): void;
    }
    export default LazyTexture;
}
declare module "texture/index" {
    export * from "texture/LazyTexture";
...
declare module "utils/Time" {
    export class Time {
        ...
        static setDelat(delta: number): void;
